...
```bash
curl -X POST -H "Content-Type: application/json" -d '{"name": "john", "cpf": "001", "email": "abc@mail.com"}' --url "http://localhost:9050/customers" -i

curl -X GET -H "Content-Type: application/json" --url "http://localhost:9050/customers/1"


curl -X POST -H "Content-Type: application/json" -d '{"cnpj": "00000", "email": "abc@mail.com", "name": "john"}' --url "http://localhost:9050/partners" -i
