...
import br.com.fullcycle.application.repositories.InMemoryCustomerRepository;
import br.com.fullcycle.application.repositories.InMemoryEventRepository;
import br.com.fullcycle.application.repositories.InMemoryTicketRepository;
...
class SubscribeCustomerToEventUseCaseTest {
    ...
    public void testReserveTicket() throws Exception {
        ...
        Assertions.assertEquals(expectedTicketsSize, actualEvent.get().getTickets().size());
    }
